        ...
        <React.Fragment>
            ...
            <Confirm
                ...
                content={`There are unsaved checklist name ${
                    activeDraft ? activeDraft.cklistName : ""
                }. Do you wish to continue?`}
                cancelButton="Never mind, Create new"
                confirmButton="Let's continue"
                onCancel={() => {
                    setOpenConfirm(false);
                    history.push("checklistadd");
                }}
                onConfirm={() => {
                    setOpenConfirm(false);
                    history.push("checklist/draft");
                }}
            />
            <Divider />
            <div className="clientTable">
                {data ? (
                    <RenderScheme data={data} />
                ) : (
                    <Dimmer active>
