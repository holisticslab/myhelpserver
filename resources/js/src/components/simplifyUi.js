...
return  editMode ?
      ...
      <Icon onClick={()=>{setEditMode(true);setNewValue(value)}} size="small" name='pencil' color="teal" link /></Header>
          ...
          >
            ...
            onSubmit={() => {
              ...
              type=="ddl"?
                  ...
                  :type=="array"?
                  <React.Fragment>
                    <Form.Input key={i} value={tempInput}  onChange={e => settempInput(e.target.value)}
                    action={{
                      color: 'teal',
                      content: "add",
                      onClick:(e)=>{
                  ...
                  <React.Fragment>
                    ...
                    <Form.Input  {...x } value="" type="file" key={i}  onChange={e => {
                    let x = [...newItem];
